...
- **Status:** APPROVED — Stages 1-2 of the companion roadmap are complete (contract frozen and reviewed; live pre-migration baseline evidence captured). Stage 3 (AP quarantine) is next.
