# AGENTS.md — Game-main Project Instructions

> Migrated from `.github/copilot-instructions.md` (original preserved).
> These instructions apply to all work in this repository in addition to CodeWhale's built-in Constitution.
