...
1. CURRENT GAME STATE SNAPSHOT: The full authoritative state of the engine at this moment. Sections included:
   ...
   - SITE INTERIOR STATE (current cell): for each site reference at the player's current L0 cell: site_id | name | enterable:YES/NO | filled:YES/NO | interior:GENERATED/NOT_GENERATED/N/A — use this to determine which sites the player can enter, which have been generated, and which are stubs
