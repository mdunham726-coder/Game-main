...
const MB_VERSION = '6.0.1';
// MB v6.0.1 (May 14, 2026): Patch -- GAMEPLAY TOOLS IMPORTANT clarification added to SYSTEM_PROMPT. Corrects a systematic misread where MB inferred that v6 added an autonomous simulation loop to the engine itself. New block explicitly states: engine architecture, timing model, lifecycle, and pipeline are unchanged; v6 only gives Mother Brain the ability to submit player inputs as a test player; treat as "Mother now has a keyboard" not "the engine now plays itself.". MB_VERSION 6.0.0 -> 6.0.1.
